# プログラミングランド v2 — 台帳アーカイブ 2026-07（過去の版の記録）

> ⚠ **これは過去の記録です。現在の計画・仕様ではありません。**
> 現状は `progland-handoff.md`（台帳）・`roadmap.md`（現在地）・`feature-spec.md`（仕様）が正。

- **収録**: `progland-handoff.md`「今どこか」から切り出した **v2.3-b4e（2026-07-12）〜 v2.3-b6k（2026-07-25）の59版**（新しい順）。原文のまま・1文字も削っていない。
...
- 切り出し元: HEAD `2dcacb7`（2026-07-24）。指示書=`brushup/handoff-archive-split.md`。

---

## 開店フェーズ 確定事項（台帳から移設・2026-07-25・原文のまま）
...
## 版ごとの詳細ログ（v2.3-b6k 〜 v2.3-b4e・新しい順）
