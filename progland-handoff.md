...
始点ずれ修正＋残り11種の台本 … ✅完了 v2.3-b6s（deploy済み・⚠️実機確認待ち）
  ＝12種そろった。★次は実機で「動きが分かりやすいか」の判断
