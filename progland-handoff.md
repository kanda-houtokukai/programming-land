...
最終更新: 2026-07-19（v2.3-b5l 実機FB第6便=b5kの追い込み4件〔看板位置/お店会話浮遊ボタン/フェード延長/音量レンジ拡大〕・実機確認待ち）
...
- **v2.3-b5l（2026-07-19・実機FB第6便=b5kの追い込み4件＝⚠️実機確認待ち）**: 指示書=Chat支給（raw実測）。スキーマ・アセット変更なし＝座標/CSS/定数/レイアウトのみ
  ...
  - ⚠️次: 神田さんの実機確認（①看板(47.3,29.25)②浮遊ボタンのbottom4%・幅340px・セリフ有無③フェード.7s・頭の間22%④音量4値[0,0.12,0.35,0.6]の大の大きさ・段の差）
