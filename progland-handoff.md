...
「みぎへ」1種類でループ再生 … ✅完了 v2.3-b6r（deploy済み・⚠️実機確認待ち）
残り11種の台本を流し込む … ★次はここ（12種の一覧は card-animation.md §4）
