...
export const XP = {
  ...
  gamelabSave: () => 10,                // ゲームこうぼう: 同上（開店フェーズ 便③・設計§D）。★スタジオと同額＝モードで差を付けると「得な方だけやる」誘因になる
};
...
export const COIN = {
  ...
  // ゲームこうぼう（開店フェーズ 便③・設計§D）: 作法は studio と同じ（作品ごとの付与ゼロ・初回マイルストーンのみ）。
  // ★後半2つが こうぼう固有＝studio の firstNest/firstCast3 の流用では「人が操作するものを作った」
  //   「勝ち負けを設計した」という こうぼうで学ぶことを拾えないため。初期値
  gamelab: { first: 15, works5: 20, works10: 30, firstOperable: 15, firstClear: 15 },
};
