...
// → b4z: 実機を見て拠点ごとに左へ戻した（一律ではなく個別＝空き地の位置に合わせて追い込み）。
// up=true はラベルを丸の「上」に出す（上下に並んだ拠点で、上側のラベルが下の拠点の丸を覆うのを防ぐ:
// 3もしも→2くりかえし ／ 6ちょうせん→5あたまのたいそう）。
const ISLAND_POS = {
  1: { left: 16.4, top: 77.5 },
  2: { left: 29.5, top: 65.5 },
  3: { left: 35.5, top: 47.5, up: true },
  4: { left: 59.7, top: 39.5 },
  5: { left: 76.5, top: 44.8 },
  6: { left: 81, top: 25.5, up: true },
};
