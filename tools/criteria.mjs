...
export const SPEC = {
  ...
  // ※島3normal・島4easy/normal の par 下限は A6 の段階設計（導入面→軽い実面のランプ）に合わせて引き下げた
  3: { easy: { w: 5, h: 4, stars: [1, 1], walls: 0.14, par: [3, 5] },
      normal: { w: 6, h: 5, stars: [1, 2], walls: 0.18, par: [4, 8] },
      hard: { w: 7, h: 6, stars: [2, 2], walls: 0.20, par: [7, 11] } },
  4: { easy: { w: 5, h: 5, stars: [1, 2], walls: 0.12, par: [3, 6] },
      normal: { w: 6, h: 5, stars: [2, 2], walls: 0.15, par: [4, 7] },
