...
// b5u ゲームこうぼう段階1: 作品/かきかけが gameConfig 込みで往復すること（stage1 §10）
p.gamelab = {
  works: [{
    id: "g1", name: "ゲーム1", savedAt: "2026-07-20", remixOf: "collect", bg: "sougen",
    gameConfig: { scoreShow: true, clear: { type: "score", param: 15 }, gameOver: null },
    chars: [{ kind: { type: "enemy", id: "slime" }, x: 2, y: 3,
      stacks: [{ x: 40, y: 40, blocks: [{ id: 1, type: "tap" }, { id: 2, type: "scoreUp", n: 1 }, { id: 3, type: "hide" }] }] }],
  }],
  draft: { bg: "arena", sel: 0, origin: { type: "new" }, name: "",
